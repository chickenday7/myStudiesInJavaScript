...
function f3(){
    let item31 = +document.querySelector('.i-31').value;
    let item32 = +document.querySelector('.i-32').value;
    let out3 = document.querySelector('.out-3');
    if (item31 > item32){
        return out3.textContent = item31;
    }else{
        return out3.textContent = item32;
    }
...
function f4(){
    let inputYear = +document.querySelector('.i-4').value;
    let out = document.querySelector('.out-4');
    if ( 2021 - inputYear >= 18){
...
function f5(){
    let inputNum = +document.querySelector('.i-5').value;
    let out5 = document.querySelector('.out-5');

    if (inputNum < 0){
        return out5.textContent = 'm';
    }else if ( inputNum == 0){
        return out5.textContent = 0;
    } else {
        return out5.textContent = 1;
    }
...
function f6(){
    ...
    if ( input % 2 == 0 ){
        return out6.textContent = 'even';
    }else{
        return out6.textContent = 'odd';
    }
}
...
function f7(){
    ...
    let input72 = document.querySelector('.i-72').value;

    return document.querySelector('.out-7').textContent = input71 ** input72;
}
...
function f9(){
    ...
    if (input9 >= 1 && input9 <=32 ){
        return out9.textContent = 'Ваш подъезд №1';
    } else if ( input9 >= 33 && input9 <= 43){
        return out9.textContent = 'Ваш подъезд №2';
    } else if (input9 >= 44 && input9 <= 64){
        return out9.textContent = 'Ваш подъезд №3';
    } else {
        return out9.textContent = 'Такая квартира отсутствует в вашем доме';
    }
}
...
function f13(){
    ...
    document.querySelector('.out-13').textContent = typeof input.value;
}
...
function f14(){
    ...
    let answer = document.querySelector('.out-14');
        if (operation == '+'){
           return answer.textContent = num1 + num2;
        }else if ( operation == '-'){
            return answer.textContent = num1 - num2;
        }else if (operation == '*'){
            return answer.textContent = num1 * num2;
