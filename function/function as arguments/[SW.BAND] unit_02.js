...
function t1(min, max) {
    ...
    let difference1 = Math.floor(Math.random() * (max - min) + min);
    document.querySelector('.out-1').textContent = difference1;    
}
...
function t3(min = 0, max = 100) {
    console.log(arguments);
    let difference1 = Math.floor(Math.random() * (max - min) + min);
    document.querySelector('.out-3').textContent = difference1;
}
...
function t4( a, b, c) {
    ...
    if ( b == 0 ){
        ...
        document.querySelector('.out-4').textContent = division;
    }
}
...
function t5(a, b, c = 0) {
    ...
    if (b == 0){
        ...
        let division = a / b;
        document.querySelector('.out-5').textContent = division;
    }
}
...
function t6(arr, block) {
    ...
    document.querySelector('.out-6').textContent = block;
}
...
function t9(text = '', block) {
    if ( block === undefined){
        document.querySelector('.out-9').textContent = ' Нет второго аргумента';
    }else{
