...
function f5() {
    let checkOut4 = document.querySelector('.out-4');
    console.log(checkOut4.classList.contains('bg-4'));
    let out5 = document.querySelector('.out-5');
    out5.textContent = checkOut4.classList.contains('bg-4');
...
function f6() {
    ...
    let itemP6 = document.querySelectorAll('.p-6');
    out6.textContent = itemP6.length;
}
...
function f11() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 25;
    document.querySelector('.out-11').appendChild(pastElement);
}
...
function f12() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 12;
    pastElement.classList.add('bg-12');
    document.querySelector('.out-12').appendChild(pastElement); 
}
...
function f13() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 'pushMe';
    pastElement.classList.add('bg-13');
    
    document.querySelector('.out-13').appendChild
    (pastElement);
    pastElement.onclick = f13_1;
}
...
function f14() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 14;
    pastElement.classList.add('bg-14');
    document.querySelector('.out-14').prepend(pastElement);
...
function f15() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 15;
    pastElement.classList.add('bg-15');
    document.querySelector('.out-15').before(pastElement);
}
...
function f16() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 16;
    pastElement.classList.add('bg-16');
    document.querySelector('.out-16').after(pastElement);
}
...
function f17() {
    let pastElement = document.createElement('div');
    pastElement.textContent = 17;
    pastElement.classList.add('bg-17');
    document.querySelector('.out-17').replaceWith(pastElement);
}
...
function f19() {
    ...
    for (let i = 0; i < p.length; i++){
       out.textContent += ' ' + p[i].getAttribute('data-b');
    }
}
